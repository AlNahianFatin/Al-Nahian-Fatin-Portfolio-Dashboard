...
import { CircleX, Eraser, Pencil, Save, Trash } from 'lucide-react';
              ...
              model === "profile" ? (
                <>
                  <button className="flex flex-row rounded-xl bg-indigo-600 px-5 py-2.5 font-semibold text-white hover:bg-indigo-600/80 hover:scale-105 hover:cursor-pointer transition-all">
                    <Save className="h-5 pr-2 pt-1.5" />Update Profile
                  </button>
                ...
                <>
                  <button className="mt-5 rounded-xl bg-indigo-600 px-5 py-2.5 font-semibold flex flex-row text-white hover:bg-indigo-600/80 hover:scale-105 hover:cursor-pointer transition-all">
                    <Save className="h-5 pr-2 pt-1.5" />{editing ? "Update" : "Save"}
                  </button>

                  <button type="button" onClick={clearForm} className="mt-5 rounded-xl flex flex-row border px-5 py-2.5 font-semibold text-slate-600 hover:bg-red-400/80 hover:text-black hover:border-black hover:scale-105 hover:cursor-pointer transition-all">
                    <Eraser className="h-5 pr-2 pt-1.5" />Clear
                  </button>
                </>
              )
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => edit(row)}
                          className="flex flex-row rounded-lg border px-3 py-1.5 text-sm hover:bg-indigo-600/80 hover:scale-105 hover:cursor-pointer transition-all">
                          <Pencil className="h-5 pr-2 pt-1.5" />Edit
                        </button>

                        <button onClick={() => setDeleteId(row.id)}
                          className="flex flex-row rounded-lg border border-red-200 px-3 py-1.5 text-sm text-red-600 hover:bg-red-400/80 hover:scale-105 hover:text-black hover:border-black hover:cursor-pointer transition-all">
                          <Trash className="h-5 pr-2 pt-1.5" />Delete
                        </button>
                      </div>
                    </div>
                  </div>
            ...
            <div className="panel max-w-sm rounded-2xl p-6 shadow-xl">
              ...
              <div className="mt-6 flex justify-end gap-3">
                <button onClick={() => setDeleteId(null)}
                  className="flex flex-row rounded-xl border px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-red-400/80 hover:text-black hover:border-black hover:scale-105 hover:cursor-pointer transition-all">
                  <CircleX className="h-5 pr-2 pt-1.5" />Cancel
                </button>

                <button onClick={confirmDelete}
                  className="flex flex-row rounded-xl bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-400/80 hover:text-black hover:border-black hover:scale-105 hover:cursor-pointer transition-all">
                  <Trash className="h-5 pr-2 pt-1.5" />Delete
                </button>
              </div>
            </div>
